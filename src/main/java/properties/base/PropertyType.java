...
public enum PropertyType {
	...
	Studio("Kitnet"), //
	Store("Loja"), //
	GroundFloorShop("Loja Térrea"), //
	Others("Outros Imóveis"), //
	FishPay("Pesque-Pague"), //
	Point("Ponto"), //
	CommercialPoint("Ponto Comercial"), //
	Inn("Pousada"), //
	Building("Prédio"), //
	OfficeBuilding("Prédio Comercial"), //
	ResidentialBuilding("Prédio Residencial"), //
	Restaurant("Restaurante"), //
	Room("Sala"), //
	CommercialRoom("Sala Comercial"), //
	SmallFarm("Sítio"), //
	SmallFarmCountryHouse("Sítio/Chácara"), //

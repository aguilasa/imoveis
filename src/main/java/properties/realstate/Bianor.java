...
public class Bianor extends RealStateHtml {

	private static final String IMOVELBASE = "https://www.bianorimoveis.com.br/";
	private static final String URLBASE = "https://www.bianorimoveis.com.br/imoveis/%s/%s/blumenau";

	public Bianor(PropertyType type, ActionType action) {
		super(type, action);
	}
	...
	public static void main(String[] args) {
		RealState imobiliaria = new Bianor(PropertyType.House, ActionType.RENT);

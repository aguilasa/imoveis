...
public class Jacinto extends RealStateHtml {

	private static final String URLBASE = "https://www.jacintoimoveis.com.br/imoveis?pretensao=%s&tipo=%d&cidade=4202404&bairro=&pagina=%d";

	public Jacinto(PropertyType type, ActionType action) {
		super(type, action);
	}
	...
	public static void main(String[] args) {
		RealState imobiliaria = new Jacinto(PropertyType.Apartment, ActionType.RENT);

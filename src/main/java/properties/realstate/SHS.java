...
public class SHS extends RealStateHtml {

	private static final String IMOVELBASE = "https://www.shsimoveis.com/";
	private static final String URLBASE = "https://www.shsimoveis.com/imoveis/%s/%s/blumenau";

	public SHS(PropertyType type, ActionType action) {
		super(type, action);
	}
	...
	public static void main(String[] args) {
		RealState imobiliaria = new SHS(PropertyType.House, ActionType.RENT);

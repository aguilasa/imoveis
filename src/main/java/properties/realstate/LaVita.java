...
public class LaVita extends RealStateHtml {

	private static final String IMOVELBASE = "https://www.lavitaimoveis.com.br/";
	private static final String URLBASE = "https://www.lavitaimoveis.com.br/imoveis/%s/%s/blumenau";

	public LaVita(PropertyType type, ActionType action) {
		super(type, action);
	}
	...
	public static void main(String[] args) {
		RealState imobiliaria = new LaVita(PropertyType.House, ActionType.RENT);

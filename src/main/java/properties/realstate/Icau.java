...
public class Icau extends RealStateHtml {

	private static final String IMOVELBASE = "https://www.icauimoveis.com.br/";
	private static final String URLBASE = "https://www.icauimoveis.com.br/imoveis/%s/%s/blumenau";

	public Icau(PropertyType type, ActionType action) {
		super(type, action);
	}
	...
	public static void main(String[] args) {
		RealState imobiliaria = new Icau(PropertyType.House, ActionType.RENT);

...
public class BluLar extends RealStateHtml {

	private static final String IMOVELBASE = "https://www.blularimoveis.com.br/";
	private static final String URLBASE = "https://www.blularimoveis.com.br/imoveis/%s/%s/blumenau";

	public BluLar(PropertyType type, ActionType action) {
		super(type, action);
	}
	...
	public static void main(String[] args) {
		RealState imobiliaria = new BluLar(PropertyType.House, ActionType.RENT);

...
public class Terrena extends RealStateHtml {

	private static final String IMOVELBASE = "https://www.terrena.com.br/";
	private static final String URLBASE = "https://www.terrena.com.br/imoveis/%s/%s/blumenau";

	public Terrena(PropertyType type, ActionType action) {
		super(type, action);
	}
	...
	public static void main(String[] args) {
		RealState imobiliaria = new Terrena(PropertyType.House, ActionType.RENT);
